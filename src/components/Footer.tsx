...
const Footer = () => {
  ...
  return (
    <footer className="py-16 bg-rose-50 border-t border-rose-200">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          <div className="col-span-2">
            ...
            <p className="text-rose-700 text-sm max-w-xs leading-relaxed">
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="font-medium text-rose-900 mb-4">{category}</h4>
        ...
        <div className="pt-8 border-t border-rose-200 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-rose-600">
            © 2025 ChainRepute. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <a href="#" className="text-rose-600 transition-colors duration-300 ease-out hover:text-rose-800">
