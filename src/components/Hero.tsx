    ...
    <section className="min-h-screen bg-rose-50 pt-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-20 pb-24 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          {/* Badge */}
          <div
            className="inline-flex items-center gap-2 px-4 py-2 bg-rose-100 border border-rose-200 rounded-full mb-8 animate-fade-in-up"
            style={{ animationDelay: '0ms', animationFillMode: 'both' }}
          >
            <span className="w-2 h-2 bg-rose-500 rounded-full"></span>
            <span className="text-sm text-rose-800">Unifying Web3 Identity</span>
          </div>

          {/* Heading */}
          <h1
            className="text-5xl md:text-6xl lg:text-7xl font-bold text-rose-900 leading-tight tracking-tight mb-6 animate-fade-in-up"
            style={{ animationDelay: '100ms', animationFillMode: 'both' }}
          >
            Your Identity Follows You
            <br />
            <span className="text-rose-700 font-bold">Across Chains</span>
          </h1>
          ...
          >
            <button className="w-full sm:w-auto px-8 py-4 bg-rose-900 text-rose-50 rounded-xl text-base font-medium transition-all duration-300 ease-out">
              Connect Wallets
            </button>
            <button className="w-full sm:w-auto px-8 py-4 bg-rose-100 text-rose-800 border border-rose-200 rounded-xl text-base font-medium transition-all duration-300 ease-out">
              Learn More
            </button>
          </div>
          ...
          >
            <p className="text-sm text-rose-500 mb-6">Trusted across ecosystems</p>
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
              {['Stellar', 'Polkadot', 'DeFi Protocols', 'DAOs', 'Communities'].map((ecosystem, index) => (
                <span
                  key={ecosystem}
                  className="text-rose-600 font-medium text-lg animate-fade-in-up"
        ...
        >
          <div className="relative max-w-5xl mx-auto">
            <div className="bg-rose-100 border border-rose-200 rounded-2xl p-2">
                ...
                <div className="p-6 md:p-8 bg-rose-50 min-h-[400px]">
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    {[
                      ...
                      <div key={stat.title} className="bg-rose-100 border border-rose-200 rounded-xl p-5">
                        <div className="w-10 h-10 bg-rose-200 rounded-lg mb-4"></div>
                        <div className="h-3 bg-rose-200 rounded w-20 mb-2"></div>
                  ...
                  <div className="bg-rose-100 border border-rose-200 rounded-xl p-6">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="text-sm text-rose-600">Minted</div>
                    </div>
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={item.chain} className="flex items-center gap-4">
                          <div className="w-8 h-8 bg-rose-200 rounded-lg"></div>
                          <div className="flex-1 font-medium text-rose-700">{item.chain}</div>
                          <div className={`px-2 py-1 rounded text-sm font-medium ${item.status === 'Verified' ? 'bg-rose-200 text-rose-800' : 'bg-rose-100 text-rose-600'}`}>
                            {item.status}
                          </div>
                        </div>
                      ))}
